    ...
    <section id="preview" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="rounded-3xl border border-slate-200/90 bg-white p-6 shadow-sm sm:p-10">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-100 pb-6">
          ...
          <Button asChild size="sm" className="self-start sm:self-auto shadow-xs">
            <Link href={isSignedIn ? "/dashboard" : "/sign-up"}>
              {isSignedIn ? "Open Dashboard" : "Launch Your Own Workspace"}
              ...
              <div className="lg:col-span-2 space-y-3">
                <div className="rounded-2xl border border-slate-200/80 bg-white p-4 shadow-2xs">
                  ...
                  <div className="mt-3 space-y-2 text-xs">
                    <div className="rounded-lg bg-rose-50/60 p-2 text-slate-600 font-mono">
                      <span className="font-bold text-rose-700 block text-[10px]">ORIGINAL:</span>
                      Built authentication and API endpoints for our app.
                    </div>
                    <div className="rounded-lg bg-emerald-50/60 p-2 text-slate-900 font-mono font-medium">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="flex size-8 items-center justify-center rounded-lg bg-indigo-50 font-bold text-xs text-indigo-700">
