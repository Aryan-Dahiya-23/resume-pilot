...
export function HeroSection({ isSignedIn = false }: { isSignedIn?: boolean }) {
  return (
    <section className="relative overflow-hidden hero-mesh py-16 sm:py-24">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-medium text-slate-600 shadow-2xs">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Button size="lg" asChild className="shadow-md shadow-indigo-500/25">
            ...
            <div className="mt-8 flex flex-col gap-3 text-xs font-medium text-slate-500 sm:flex-row sm:items-center sm:gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Strict Privacy: No Data Training</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-indigo-500 to-purple-600 opacity-20 blur-xl" />

            <div className="relative rounded-3xl border border-slate-200/90 bg-white/95 p-6 shadow-xl backdrop-blur-md sm:p-7">
              {/* Header */}
              ...
              <div className="mt-5 flex items-center justify-between gap-4 rounded-2xl border border-slate-100 bg-slate-50/70 p-4">
                <div>
                  ...
                  <div className="mt-1 text-3xl font-extrabold text-slate-900">
                    84 <span className="text-base font-normal text-slate-400">/ 100</span>
                  </div>
                  <div className="text-xs text-emerald-600 font-medium mt-0.5">
                    Top 8% of candidate resumes
                  </div>
                </div>
                <ProgressRing value={84} size={90} strokeWidth={9} />
              </div>
              ...
              <div className="mt-5 border-t border-slate-100 pt-4 flex items-center justify-between text-xs text-slate-500">
                <div className="flex items-center gap-2">
                  ...
                  <span>Pipeline: 14 Applications • 4 Interviews</span>
                </div>
                <span className="font-semibold text-indigo-600">28% Rate</span>
              </div>
            </div>
          </div>
        </div>
