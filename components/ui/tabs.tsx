...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-start sm:justify-center rounded-xl bg-slate-100/90 p-1 text-slate-500 overflow-x-auto max-w-full no-scrollbar",
      className,
    )}
    {...props}
  />
